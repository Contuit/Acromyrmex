...
var SelectInput = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SelectInput, [{
    ...
    value: function render() {
      ...
      var selectInput = loading ? /*#__PURE__*/_react["default"].createElement(_Loading["default"], null) : /*#__PURE__*/_react["default"].createElement(_reactSelect["default"], _extends({}, inputProps, {
        name: input.name,
        title: myOptions.length === 0 ? 'no available options' : '',
        disabled: myOptions.length === 0 || disabled,
        value: myOptions.filter(function (option) {
