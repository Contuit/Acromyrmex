...
var CheckboxInput = /*#__PURE__*/function (_React$Component) {
  ...
  function CheckboxInput() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(CheckboxInput).apply(this, arguments));
  }
  ...
  _createClass(CheckboxInput, [{
    ...
    value: function render() {
      ...
      var helpPopover = _react["default"].createElement(_UiComponents.Popover, {
        id: "field-".concat(inputProps.name, "-help")
      }, help);
      ...
      }, _react["default"].createElement(_UiComponents.Checkbox, _extends({
        inline: true
      }, inputProps, {
        disabled: disabled,
        checked: _underscore["default"].isString(value) && value === 'true' || _underscore["default"].isBoolean(value) && inputProps.value
      }), !noLabel && _react["default"].createElement("span", null, prefix, " ", label, ' ', help && _react["default"].createElement(_UiComponents.OverlayTrigger, {
        trigger: ['hover', 'focus'],
        placement: "right",
        overlay: helpPopover,
        rootClose: true
...
CheckboxInput.shouldComponentUpdate = _FormField["default"].shouldFormFieldUpdate;
