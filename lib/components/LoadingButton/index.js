...
var _excluded = ["icon", "label", "loading", "disabled", "loadingLabel"];
...
var LoadingButton = function LoadingButton(props) {
  ...
  }, btnProps), loading ? /*#__PURE__*/_react["default"].createElement("span", null, /*#__PURE__*/_react["default"].createElement(_Loading["default"], {
    inline: true,
    delay: false
  ...
  }), loadingLabel || "".concat(label, "ing"), "\u2026") : /*#__PURE__*/_react["default"].createElement("span", null, icon && /*#__PURE__*/_react["default"].createElement("img", {
    src: icon,
    alt: "...",
    className: "LoadingButton__icon"
  }), label));
